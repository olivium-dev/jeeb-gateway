...
public static class BusinessOutcomeTelemetry
{
    ...
    // gwdbx W2-R11: the ledger belongs to settlement-service. These counters stay as the
    // observable trace of a settle that did not land (ties into JEBV4-59 business counters).
