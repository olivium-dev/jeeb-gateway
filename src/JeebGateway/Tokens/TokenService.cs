...
public class TokenService : ITokenService
{
    ...
    public async Task<TokenPair> IssueAsync(string userId, IEnumerable<string> roles, CancellationToken ct)
    {
        ...
        var access = BuildAccessToken(userId, roles, now, accessExpires);
    ...
    public async Task<RefreshResult> RefreshAsync(string refreshToken, CancellationToken ct)
    {
        ...
        var access = BuildAccessToken(existing.UserId, roles, now, accessExpires);
    ...
    private string BuildAccessToken(string userId, IEnumerable<string> roles, DateTimeOffset now, DateTimeOffset expires)
    {
