...
public sealed class AdminDeliveryEvidenceSecurityTests
{
    ...
    public async Task ListRewritesOwnerReferenceAndEvidenceStreamsOnlyAfterOwnerVerification()
    {
        ...
        var controller = new AdminDeliveriesController(
            factory, null!, null!, null!, null!, new EmptySettlementPortal(), configuration)
        {
    ...
    public async Task DetailComposesBoundedRouteAndChatUsingTheActiveDeliveryClient()
    {
        ...
        var controller = new AdminDeliveriesController(
            factory, null!, null!, geo, chat, new EmptySettlementPortal(), configuration)
        {
    ...
    public async Task DeliveryReadDoesNotGrantCaseOrSettlementEvidenceCapabilities()
    {
        ...
        var controller = new AdminDeliveriesController(
            ...
            new EmptySettlementPortal(), new ConfigurationBuilder().Build())
        {
            ControllerContext = new ControllerContext
            {
                HttpContext = new DefaultHttpContext
    ...
    public async Task FreshMfaTransitionForwardsExactOwnerContractWithoutCredentials()
    {
        ...
        var controller = new AdminDeliveriesController(
            factory, null!, null!, null!, null!, new EmptySettlementPortal(),
    ...
    public async Task TransitionWithoutFreshMfaFailsBeforeOwnerDial()
    {
        ...
        var controller = new AdminDeliveriesController(
            factory, null!, null!, null!, null!, new EmptySettlementPortal(), new ConfigurationBuilder().Build())
        {
            ControllerContext = new ControllerContext
            {
                HttpContext = new DefaultHttpContext
    ...
    private sealed class EmptySettlementPortal : JeebGateway.Financials.IAdminSettlementPortalService
    {
        public Task<JeebGateway.Admin.AdminSettlementPageResponse> ListAsync(
            JeebGateway.Financials.AdminSettlementPortalListRequest request, CancellationToken ct) =>
        ...
        public Task<JeebGateway.Financials.AdminSettlementMarkPaidResult> MarkBatchPaidAsync(
            string batchId, int expectedVersion, string paymentReference, string reason,
            string adminId, CancellationToken ct) =>
            Task.FromResult(new JeebGateway.Financials.AdminSettlementMarkPaidResult(
                JeebGateway.Financials.AdminSettlementMarkPaidOutcome.NotFound, null));
    }
}
